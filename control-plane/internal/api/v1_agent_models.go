...
// (Settings → AI Agents; see docs/agent-auth.md). All of them expose the same
...
// OpenRouter, NVIDIA) also answer without one (a public/free-tier catalog).
//
...
// listed here (Google, Bedrock, Azure, …) returns 400 — the console falls
// back to its free-text model field for those.
package api
